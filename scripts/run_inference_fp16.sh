...
gnome-terminal -e "roslaunch /home/nvidia/catkin_ws/src/stereo_dnn_ros/launch/ResNet18_2D_fp16.launch"
echo "Done!"
sleep 10
echo "Starting bottle depth node"
gnome-terminal -e "rosrun ros_deep_learning depth_estimation.py depth_statistics_16"
echo "Done!"
sleep 5
